...
public class XLogger {
   ...
   * @param jumpToSource 是否跳转到源码
   */
  public static void init(String cacheDir, String logDir, String LogFileName, String pubKey,
      boolean consoleLogOpen, int logLevelControl,
